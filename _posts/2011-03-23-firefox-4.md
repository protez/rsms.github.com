...
As with most modern browsers, multitasking in Firefox is based around a [tabbed user interface](http://en.wikipedia.org/wiki/Tab_(GUI). The window of Firefox 4 looks like this:
